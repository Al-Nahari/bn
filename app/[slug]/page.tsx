              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <button
                    ...
                    className="mt-4 w-full sm:w-auto flex items-center justify-center gap-2 border-2 border-coffee-medium text-coffee-medium px-8 py-4 rounded-xl text-lg font-semibold hover:bg-coffee-medium hover:text-white transition-all duration-300"
                  >
